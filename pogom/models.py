    ...
    for cell in cells:
        if config['parse_pokemon']:
            for p in cell.get('wild_pokemons', []):
                ...
                if (args.encounter and p['pokemon_data']['pokemon_id'] in args.encounter_whitelist and args.encounter_whitelist or
                        p['pokemon_data']['pokemon_id'] not in args.encounter_blacklist and args.encounter_blacklist):
